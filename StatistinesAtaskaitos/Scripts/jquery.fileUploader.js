	...
	$.fn.fileUploader = function(config){
			...
			$(pxUploadForm).append(
				...
				.append(' \
					<ul class="actions ui-helper-clearfix"> \
						<li title="Įkelti" class="upload ui-state-default ui-corner-all"> \
							<span class="ui-icon ui-icon-circle-triangle-e"></span> \
						</li> \
						<li title="Pašalinti" class="delete ui-state-default ui-corner-all"> \
		...
		*/
		function beforeEachUpload($form) {
			...
			$uploadData = $form.parent();
			$uploadData.find('.status').text('Įkeliama...');
